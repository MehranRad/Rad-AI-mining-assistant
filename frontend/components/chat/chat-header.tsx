...
export function ChatHeader({ showTechnical, onToggleTechnical }: ChatHeaderProps) {
  return (
    <header
      className="flex items-center justify-between px-6 py-4 border-b border-neutral-800/80 bg-neutral-950/40 backdrop-blur-sm"
      dir="rtl"
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-neutral-500 mt-1">آماده پاسخگویی · معدن مس</p>
        </div>
      </div>
